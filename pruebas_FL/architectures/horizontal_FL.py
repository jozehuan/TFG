...
class HFL_model:
    ...
    def __init__(self, name : str = 'modelname', dataset_root : str ='datasets', download : bool = True, transform : callable = None
                     ...
                     , server_weight : float = 0.2, balance_classes : bool = True
                     , alpha_inf : float = 0.4, alpha_sup : float = 0.6):
    ...
    def set_explainers(self, *args, **kwargs):
        ...
        self._flex_pool.servers.map(set_LimeImageExplainer, name='lime__felz', top_labels = 10, num_samples=2000, algo_type='felzenszwalb', segment_params={'scale' : 0.4, 'sigma' : 0.8, 'min_size' : 20})
    ...
    def get_explanations(self, data = None):
        ...
        self._flex_pool.servers.map(plot_heatmap, pathname='images/' + self._name)
